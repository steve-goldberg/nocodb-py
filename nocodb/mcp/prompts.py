...
| Tables | full CRUD | Yes |
| Fields | full CRUD | Yes |
| Records | full CRUD | Yes |
| Links | full CRUD | Yes |
| Views | list, update, delete | Cannot create views via API |
| View Filters/Sorts | full CRUD | Yes |
| View Columns | full CRUD | Yes |
| Shared Views | full CRUD | Yes |
| Webhooks | list, delete | Cannot create/update via API |
| Webhook Logs | read | Yes |
| Webhook Filters | list, create | Yes |
| Export CSV | export | Yes |
| Storage | upload | Yes |
| Attachments | upload | Yes |
| Members | full CRUD | Yes |
